 ...
 */
final class Version20220414115657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE membre_id membre_id INT DEFAULT NULL, CHANGE vehicule_id vehicule_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE membre_id membre_id INT NOT NULL, CHANGE vehicule_id vehicule_id INT NOT NULL');
    }
}
